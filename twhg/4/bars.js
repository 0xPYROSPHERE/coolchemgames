function drawBars() {
    if (mobile) {
        ...
        if (state == "game" || state == "intermission") {
            ...
            canvas.fillText("LEVEL: " + realLevel + " - " + labels[level-1] , cwh(BAR_TEXT_FIX) + os.x, cwh(BAR_HEIGHT / 2 + BAR_TEXT_FIX) + os.y);

            if (getCoinsTotalAll() > 0) {
                canvas.fillStyle = "white";
                canvas.font = cwh(30) + "px Arial";
                canvas.textAlign = "center";
                canvas.fillText("COINS: " + getCoinsCollectedAll() + "/" + getCoinsTotalAll(), cwh(CANVAS_WIDTH / 2) + os.x, cwh(BAR_HEIGHT / 2 + BAR_TEXT_FIX) + os.y);
            }
        ...
        if (state == "game" || state == "intermission") {
            ...
            canvas.font = "30px Arial";
            canvas.textAlign = "left";
            canvas.fillText("LEVEL: " + realLevel + " - " + labels[level-1] , BAR_TEXT_FIX, BAR_HEIGHT / 2 + BAR_TEXT_FIX);

            if (getCoinsTotalAll() > 0) {
                canvas.fillStyle = "white";
                canvas.font = "30px Arial";
                canvas.textAlign = "center";
                canvas.fillText("COINS: " + getCoinsCollectedAll() + "/" + getCoinsTotalAll(), CANVAS_WIDTH / 2, BAR_HEIGHT / 2 + BAR_TEXT_FIX);
            }
