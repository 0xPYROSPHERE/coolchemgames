...
var doors = [
	...
	// level 1
	[
	  new door(18, 8, 2, 2, "right",1)
	],
	// level 2
	[
	   new door(2, 12, 2, 2, "right",4),
	   new door(14, 4, 4, 2, "right",3),
	   new door(20, 7, 3, 1, "right",2)
	  
	   
	],
	// level 3
	[
	  new door(14, 10, 4, 1, "right",14),
	  new door(14, 11, 4, 1, "right",16),
	 
	  
	],
	// level 4
	[
        new door(15, 16, 2, 5, "right",6)
	],
	// level 5
	[
	  new door(14, 17, 2, 1, "right",8),
	  new door(25, 6, 1, 2, "right",9),
	  new door(25, 18, 4, 1, "right",10),
	   new door(25, 19, 4, 1, "right",11),
	  
	  
	],
	// level 6
	[ 
	   new door(25, 16, 2, 3, "right",15),
	],
	// level 7
	[
	...
	[
	    ...
	    new door(10, 9, 3, 2, "right",13),
		new door(20, 9, 3, 2, "right",12),
	...
	// level 10
	[
	  new door(18, 18, 2, 2, "right",17)
	],
	// level 11
	[
	 new door(16, 6, 2, 1, "right",18),
	],
	// level 12
	[
	   new door(2, 18, 1, 2, "right",5),
	   new door(5, 9, 5, 2, "right",19,true),
	   new door(23, 18, 3, 2, "right",7)
	   
	   
	],
	// level 13
	[
	   new door(3, 3, 4, 2, "left",1),
	   new door(25, 14, 4, 2, "bottom",2),
	
	],
	// level 14
	[
	  new door(2, 8, 1, 4, "bottom",13),
	   new door(29, 4, 1, 4, "bottom",26),
	   new door(25, 8, 4, 2, "bottom",15),
	   
	],
	// level 15
	[
	  new door(2, 16, 1, 4, "bottom",12),
	  new door(29, 16, 1, 4, "bottom",3)
	],
	// level 16
	[
	   //new door(31, 19, 2, 1, "bottom",1900),
	],
	// level 17
	[ 
	   new door(22, 20, 2, 1, "bottom",14),
	],
	// level 18
	[
	...
	// level 20
	[
	 new door(5, 4, 1, 2, "left",4),
	 new door(9, 4, 1, 2, "left",5),
	 new door(13, 4, 1, 2, "left",6),
	 
	 
	 new door(14, 14, 1, 3, "left",7),
	 new door(18, 10, 1, 3, "left",8),
	 new door(29, 14, 1, 2, "left",9),
	 new door(30, 14, 1, 2, "left",10),
	 
	 
	],
	// level 21
	[
	   new door(2, 14, 1, 2, "left",11)
	],
	// level 22
	[
	   new door(7, 16, 1, 4, "left",18),
	   new door(3, 15, 2, 1, "left",20),
	   new door(12, 16, 1, 4, "left",16),
	   new door(17, 16, 1, 4, "left",17),
	   
	   new door(17, 11, 1, 3, "left",21),
	   new door(25, 4, 4, 2, "left",19),
	...
	// level 24
	[
	 new door(3, 12, 4, 2, "left",27,true),
	 new door(3, 6, 2, 2, "left",25),
	 new door(9, 4, 2, 2, "left",23),
	 new door(7, 10, 2, 2, "left",24),
	  new door(9, 10, 2, 2, "left",22),
	 
	],
	// level 25
	[
	 new door(2, 4, 1, 3, "left",2),
	 new door(2, 17, 1, 3, "left",1),
	...
	// level 27
	[
	 new door(29, 4, 1, 4, "left",4),
	 new door(29, 16, 1, 4, "left",3),
	 
	],
	// level 28
	[ 
	 new door(7, 19, 2, 1, "left",8),
	 new door(7, 20, 2, 1, "left",6),
	 
	 new door(18, 19, 2, 1, "left",9),
	 new door(18, 20, 2, 1, "left",5),
	 
	 new door(29, 19, 2, 1, "left",10),
	 new door(29, 20, 2, 1, "left",7),
	...
	// level 30
	[
	 new door(3, 20, 4, 1, "left",12),
	 new door(20, 20, 4, 1, "left",11)
	],
	// level 31
	[
	  new door(27, 5, 2, 1, "left",13),
	 new door(29, 18, 1, 2, "left",14)
	],
	// level 32
	[
	...
	// level 34
	[
	   new door(14, 3, 4, 1, "left",18),
	   new door(14, 4, 4, 1, "left",17),
	   new door(14, 5, 4, 1, "left",16),
	   new door(7, 3, 1, 1, "left",15),
	...
	// level 36
	[ 
	  new door(20, 8, 3, 8, "left",19,true),
	  
	],
	// level 37
	[
	 new door(1, 17, 1, 3, "left",3),
	 new door(2, 20, 4, 1, "left",1),
	 
	 new door(2, 21, 4, 1, "left",2),
	 new door(14, 10, 4, 1, "left",4),
	...
	// level 39
	[
	  new door(12, 10, 1, 4, "left",5),
	  new door(13, 10, 1, 4, "left",6),
	  new door(14, 8, 4, 1, "left",29),
	  new door(14, 9, 4, 1, "left",28),
	  
	   new door(29, 4, 1, 4, "left",8),
	   new door(30, 4, 1, 4, "left",7),
	  
	],
	// level 40
	[ 
	  new door(14, 20, 4, 1, "left",19),
	],
	// level 41
	[
	  new door(2, 20, 4, 1, "left",13)
	],
	// level 42
	[
	  new door(20, 20, 4, 1, "left",9),
	  new door(29, 4, 1, 2, "left",10),
	  new door(29, 6, 1, 2, "left",11),
	  new door(30, 4, 1, 4, "left",12),
	  
	  
	],
	// level 43
	[
	/* new door(20, 20, 4, 1, "left",200),
	  new door(29, 4, 1, 2, "left",200),
	  new door(29, 6, 1, 2, "left",200),*/
	],
	// level 44
	[ 
	// new door(33, 21, 1, 1, "left",100),
	],
	// level 45
	[ 
	  new door(1, 7, 1, 1, "left",21),
	  new door(2, 4, 1, 1, "left",17),
	  new door(2, 5, 1, 1, "left",20),
	],
	// level 46
	[
	   new door(13, 11, 1, 2, "left",15),
	  new door(18, 11, 1, 2, "left",16),
	  new door(17, 15, 2, 6, "left",14),
	],
	// level 47
	[ 
	  new door(2, 9, 4, 1, "left",25),
	  new door(12, 20, 4, 1, "left",26),
	  new door(22, 20, 4, 1, "left",23),
	  new door(18, 10, 1, 4, "left",22),
	  new door(12, 3, 4, 1, "left",27),
	  new door(22, 3, 4, 1, "left",24),
	  
	],
	// level 48
	[ 
	 new door(23, 9, 2, 6, "left",250,true),
	],
	// level 49
	[],
	// level 50
...
Math.floor(mouseX / TILE_SIZE) + ", " + Math.floor(mouseY / TILE_SIZE), 7, 60 + cwh(BAR_TEXT_FIX));*/
            var addToDoor = 0; 
			if((doors[lev][i].doorNumber == 9 || (doors[lev][i].doorNumber == 10) ) && lev == 20  )
				addToDoor = doors[lev][i].addToDoorTime;
			if (doors[lev][i].opening == true) {
				if (doors[lev][i].dir == "right" || doors[lev][i].dir == "left") {
					doors[lev][i].curW -= (DOOR_OPEN_SPEED+ addToDoor);
					...
					doors[lev][i].curH -= (DOOR_OPEN_SPEED+ addToDoor);
...
function submitSavedDoors() {
	...
	if (doorsSave.length == 0)
		doorsSave.push(-99);
	localStorage.setItem("whg4_doors", JSON.stringify(doorsSave));
}

function loadSavedDoors() {
	resetDoors(level);
	doorsSave = JSON.parse(localStorage["whg4_doors"]);
	currentSave = [];
	 for (var t = 0; t< levelsNumbers[realLevel].length;t++ ){
		 lev = levelsNumbers[realLevel][t];
		 if(doorsSave!= -99){
