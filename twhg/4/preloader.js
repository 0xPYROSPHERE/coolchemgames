...
function initImages() {
    ...
    img_mainMenu.crossOrigin = "anonymous";
    img_mainMenu.src             = "images/main_menu2.png";
...
function initSounds() {
	...
	sfx_die_water         = new Audio("sounds/sfx_die_water.mp3");
	sfx_die_pit         = new Audio("sounds/sfx_die_pit.mp3");
	...
	soundsToMute.push(sfx_die_water);
	soundsToMute.push(sfx_die_pit);
	...
	sfx_die_water.addEventListener       ("canplaythrough", soundLoaded);
	sfx_die_pit.addEventListener         ("canplaythrough", soundLoaded);
}
...
function soundLoaded() {
	...
	if (loadedSounds >= TOTAL_SOUNDS) {
		...
		sfx_die_water.removeEventListener       ("canplaythrough", soundLoaded);
	    sfx_die_pit.removeEventListener         ("canplaythrough", soundLoaded);
...
function drawPreloader() {
	...
	canvas.font = cwh(16) + "px Arial";
	canvas.textAlign = "center";
	canvas.fillText("This is The World's Hardest Game 4.", cwh(CANVAS_WIDTH / 2) + os.x, cwh(310) + os.y);
