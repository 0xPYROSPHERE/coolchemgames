...
const ENEMY_OUTLINE_COLOR_0 = "#000066";
const KEY_OUTLINE_COLOR_0 = "rgba(0, 0, 68,)";
...
const ICE_COLOR = "rgba(190, 240, 244, 0.5) ";
const WATER_COLOR = "rgba(115, 161, 253, 0.65) ";

const ARROW_COLOR = "rgba(175, 174, 176, 0.9)";
const ARROW_COLOR_BACK = "rgba(213, 211, 214, 0.5)";
const ARROW_COLOR_RED = "rgba(255, 0, 0, 0.5)";
...
const DOOR_FILL_COLOR = "rgba(124, 124, 124, 1)";
const DOOR_OUTLINE_COLOR = "rgba(50, 50, 50, 1)";

const DOOR_MAIN_COLOR = "rgba(254, 200, 3, 1)";;//"FFCC00";
//[254, 200, 3]
const KEY_OUTLINE_COLOR = 	"rgba(128, 128, 128,";
...
const SHADOW_COLOR = "rgba(128, 128, 128, ";
