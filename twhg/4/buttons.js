var buttons = [
	...
	["mm_playGame",       70, 415, 345, 405, ["main_menu"]],
    ["mm_levelSelect",    480, 740, 219, 274, ["main_menu"]], 
   
	["mm_mute2___",          325, 583, 540, 588, ["main_menu"]],
	
	["mm_continue",          70, 400, 470, 505, ["main_menu"]],
 
  

//    ["mm_stephenCritoph",   1, 518,   0,  50, ["main_menu", "level_select", "finish"]],
//    ["mm_snayk",          518, 800,   0,  50, ["main_menu", "level_select", "finish"]],
    ["mm_mute",           660, 795, 560 , 590, ["level_select", "finish","main_menu"]],
	["mm_newgame",           40, 380, 412 , 440, ["main_menu"]],
	["mm_home",           420, 690, 412 , 440, ["main_menu"]],
    ...
    ["bars_mute",        660, 795, 560 , 590, ["intermission", "game"]],
...
function newGameButton() {
	...
	playSFX(sfx_intermission);
	    ...
	    localStorage.setItem("whg4_color", player.color);
		player.color = 0;
		resetCoinsAll();
		resetDoorsAll();
		//resetEnemiesAll();
...
function continueButton() {
	 playSFX(sfx_intermission);
	    ...
	    if (localStorage.getItem("whg4_level") == null) {
			...
			gameTimer = parseInt(localStorage.getItem("whg4_gameTimer"));
	        level     = parseInt(localStorage.getItem("whg4_level"));
			realLevel     = parseInt(localStorage.getItem("whg4_realLevel"));
			
	        deaths    = parseInt(localStorage.getItem("whg4_deaths"));
	        curCheck  = parseInt(localStorage.getItem("whg4_curCheck"));
			
			curCheckLevel = level;
			
			player.color = parseInt(localStorage.getItem("whg4_color"));
			//localStorage.setItem("whg3_colors", player.colorsCollected);
	        
			changeColor();
			if(localStorage.getItem("whg4_colors")!=null)
			 player.colorsCollected = getBoolArray(localStorage.getItem("whg4_colors"));
		    
			if(localStorage.getItem("whg4_opened")!=null)
			 player.levelOpened =  getBoolArray(localStorage.getItem("whg4_opened"));
