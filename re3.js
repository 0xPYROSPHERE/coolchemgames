...
(() => {
    ...
    async function loadPackage(metadata) {
        ...
        var PACKAGE_NAME = "re3.data";
        var REMOTE_PACKAGE_BASE = "re3.data";
        ...
        async function fetchRemotePackage(packageName, packageSize) {
            ...
            try {
                var response = await fetch(processedUrl);
            } catch (e) {
        ...
        async function runWithFS(Module) {
            ...
            Module["FS_createPath"]("/", "Icons", true, true);
            Module["FS_createPath"]("/", "ReadMe", true, true);
            Module["FS_createPath"]("/", "TEXT", true, true);
            Module["FS_createPath"]("/", "Website", true, true);
            Module["FS_createPath"]("/", "anim", true, true);
            Module["FS_createPath"]("/", "audio", true, true);
            Module["FS_createPath"]("/", "data", true, true);
            Module["FS_createPath"]("/data", "maps", true, true);
            Module["FS_createPath"]("/data/maps", "comnbtm", true, true);
            Module["FS_createPath"]("/data/maps", "comntop", true, true);
            Module["FS_createPath"]("/data/maps", "comroad", true, true);
            Module["FS_createPath"]("/data/maps", "comse", true, true);
            Module["FS_createPath"]("/data/maps", "comsw", true, true);
            Module["FS_createPath"]("/data/maps", "indroads", true, true);
            Module["FS_createPath"]("/data/maps", "industne", true, true);
            Module["FS_createPath"]("/data/maps", "industnw", true, true);
            Module["FS_createPath"]("/data/maps", "industse", true, true);
            Module["FS_createPath"]("/data/maps", "industsw", true, true);
            Module["FS_createPath"]("/data/maps", "landne", true, true);
            Module["FS_createPath"]("/data/maps", "landsw", true, true);
            Module["FS_createPath"]("/data/maps", "making", true, true);
            Module["FS_createPath"]("/data/maps", "subroads", true, true);
            Module["FS_createPath"]("/data/maps", "temppart", true, true);
            ...
            Module["FS_createPath"]("/", "movies", true, true);
            Module["FS_createPath"]("/", "mp3", true, true);
            Module["FS_createPath"]("/", "mss", true, true);
            ...
            async function processPackageData(arrayBuffer) {
                ...
                Module["removeRunDependency"]("datafile_re3.data");
            }
            Module["addRunDependency"]("datafile_re3.data");
    ...
    loadPackage({
        files: [
            { filename: "/.DS_Store", start: 0, end: 14340 },
            { filename: "/Icons/gta3.ico", start: 14340, end: 16578 },
            { filename: "/Icons/gtaPcWaste.ico", start: 16578, end: 18816 },
            { filename: "/Icons/rockstar.ico", start: 18816, end: 24510 },
            { filename: "/Mss32.dll", start: 24510, end: 362942 },
            { filename: "/ReadMe/ReadMe.txt", start: 362942, end: 372917 },
            { filename: "/ReadMe/ReadMe_FRENCH.txt", start: 372917, end: 383932 },
            { filename: "/ReadMe/ReadMe_GERMAN.txt", start: 383932, end: 394373 },
            { filename: "/ReadMe/ReadMe_SPANISH.txt", start: 394373, end: 405462 },
            { filename: "/ReadMe/Readme_ITALIAN.txt", start: 405462, end: 415677 },
            { filename: "/TEXT/american.gxt", start: 415677, end: 634269 },
            { filename: "/TEXT/english.gxt", start: 634269, end: 838763 },
            { filename: "/TEXT/french.gxt", start: 838763, end: 1083273 },
            { filename: "/TEXT/german.gxt", start: 1083273, end: 1323727 },
            { filename: "/TEXT/italian.gxt", start: 1323727, end: 1563655 },
            { filename: "/TEXT/spanish.gxt", start: 1563655, end: 1809759 },
            { filename: "/Website/website.url", start: 1809759, end: 1809843 },
            { filename: "/anim/cuts.dir", start: 1809843, end: 1819059 },
            { filename: "/anim/cuts.img", start: 1819059, end: 45453747 },
            { filename: "/anim/gta3.ini", start: 45453747, end: 45453757 },
            { filename: "/anim/ped.ifp", start: 45453757, end: 47503157 },
            { filename: "/audio/A1_a.wav", start: 47503157, end: 47511409 },
            { filename: "/audio/AMMU_A.wav", start: 47511409, end: 47520173 },
            { filename: "/audio/AMMU_C.wav", start: 47520173, end: 47535849 },
            { filename: "/audio/AMMU_b.wav", start: 47535849, end: 47543845 },
            { filename: "/audio/BET.mp3", start: 47543845, end: 48134967 },
            { filename: "/audio/CHAT.wav", start: 48134967, end: 48250739 },
            { filename: "/audio/CLASS.wav", start: 48250739, end: 48366511 },
            { filename: "/audio/COMopen.wav", start: 48366511, end: 48914411 },
            { filename: "/audio/City.wav", start: 48914411, end: 49030183 },
            { filename: "/audio/END.mp3", start: 49030183, end: 57626478 },
            { filename: "/audio/FLASH.wav", start: 57626478, end: 57742250 },
            { filename: "/audio/GAME.wav", start: 57742250, end: 57858022 },
            { filename: "/audio/HEAD.wav", start: 57858022, end: 57973794 },
            { filename: "/audio/JB.mp3", start: 57973794, end: 59783685 },
            { filename: "/audio/K3_A.wav", start: 59783685, end: 59795521 },
            { filename: "/audio/KJAH.wav", start: 59795521, end: 59911293 },
            { filename: "/audio/LIPS.wav", start: 59911293, end: 60027065 },
            { filename: "/audio/MSX.wav", start: 60027065, end: 60142837 },
            { filename: "/audio/Miscom.wav", start: 60142837, end: 60570929 },
            { filename: "/audio/RISE.wav", start: 60570929, end: 60686701 },
            { filename: "/audio/SFX.RAW", start: 60686701, end: 141536169 },
            { filename: "/audio/SUBopen.wav", start: 141536169, end: 142080081 },
            { filename: "/audio/Water.wav", start: 142080081, end: 142195853 },
            { filename: "/audio/YD2_A.wav", start: 142195853, end: 142235337 },
            { filename: "/audio/a1_sso.wav", start: 142235337, end: 144156511 },
            { filename: "/audio/a2_pp.wav", start: 144156511, end: 145031157 },
            { filename: "/audio/a3_a.wav", start: 145031157, end: 145082357 },
            { filename: "/audio/a3_ss.wav", start: 145082357, end: 146884749 },
            { filename: "/audio/a4_a.wav", start: 146884749, end: 146897353 },
            { filename: "/audio/a4_b.wav", start: 146897353, end: 146909957 },
            { filename: "/audio/a4_c.wav", start: 146909957, end: 146923329 },
            { filename: "/audio/a4_d.wav", start: 146923329, end: 146936445 },
            { filename: "/audio/a4_pdr.wav", start: 146936445, end: 148329235 },
            { filename: "/audio/a5_a.wav", start: 148329235, end: 148407939 },
            { filename: "/audio/a5_k2ft.wav", start: 148407939, end: 149266201 },
            { filename: "/audio/a6_bait.wav", start: 149266201, end: 150669233 },
            { filename: "/audio/a7_etg.wav", start: 150669233, end: 152041545 },
            { filename: "/audio/a8_ps.wav", start: 152041545, end: 153995397 },
            { filename: "/audio/a9_asd.wav", start: 153995397, end: 154611907 },
            { filename: "/audio/c1_tex.mp3", start: 154611907, end: 155655679 },
            { filename: "/audio/cat1.wav", start: 155655679, end: 155667259 },
            { filename: "/audio/copybyte.exe", start: 155667259, end: 155709755 },
            { filename: "/audio/d1_stog.mp3", start: 155709755, end: 156447163 },
            { filename: "/audio/d2_kk.mp3", start: 156447163, end: 157132326 },
            { filename: "/audio/d3_ado.mp3", start: 157132326, end: 157562534 },
            { filename: "/audio/d4_gta.mp3", start: 157562534, end: 158007371 },
            { filename: "/audio/d4_gta2.mp3", start: 158007371, end: 159423127 },
            { filename: "/audio/d5_es.mp3", start: 159423127, end: 159728783 },
            { filename: "/audio/d6_sts.mp3", start: 159728783, end: 160051993 },
            { filename: "/audio/d7_mld.mp3", start: 160051993, end: 160320033 },
            { filename: "/audio/door_1.wav", start: 160320033, end: 160332381 },
            { filename: "/audio/door_2.wav", start: 160332381, end: 160339097 },
            { filename: "/audio/door_3.wav", start: 160339097, end: 160363221 },
            { filename: "/audio/door_4.wav", start: 160363221, end: 160385553 },
            { filename: "/audio/door_5.wav", start: 160385553, end: 160386125 },
            { filename: "/audio/door_6.wav", start: 160386125, end: 160386697 },
            { filename: "/audio/el3_a.wav", start: 160386697, end: 160450839 },
            { filename: "/audio/el_ph1.mp3", start: 160450839, end: 160806232 },
            { filename: "/audio/el_ph2.mp3", start: 160806232, end: 161383144 },
            { filename: "/audio/el_ph3.mp3", start: 161383144, end: 161959220 },
            { filename: "/audio/el_ph4.mp3", start: 161959220, end: 162407818 },
            { filename: "/audio/h5_a.wav", start: 162407818, end: 162441158 },
            { filename: "/audio/h5_b.wav", start: 162441158, end: 162454786 },
            { filename: "/audio/h5_c.wav", start: 162454786, end: 162465342 },
            { filename: "/audio/hd_ph1.mp3", start: 162465342, end: 162976634 },
            { filename: "/audio/hd_ph2.mp3", start: 162976634, end: 163247600 },
            { filename: "/audio/hd_ph3.mp3", start: 163247600, end: 163619712 },
            { filename: "/audio/hd_ph4.mp3", start: 163619712, end: 163974269 },
            { filename: "/audio/hd_ph5.mp3", start: 163974269, end: 164328826 },
            { filename: "/audio/j0_dm2.mp3", start: 164328826, end: 164787037 },
            { filename: "/audio/j1_lfl.mp3", start: 164787037, end: 165295403 },
            { filename: "/audio/j2_kcl.mp3", start: 165295403, end: 165819652 },
            { filename: "/audio/j3_vh.mp3", start: 165819652, end: 166274520 },
            { filename: "/audio/j4_a.wav", start: 166274520, end: 166289684 },
            { filename: "/audio/j4_b.wav", start: 166289684, end: 166309456 },
            { filename: "/audio/j4_c.wav", start: 166309456, end: 166327436 },
            { filename: "/audio/j4_d.wav", start: 166327436, end: 166352328 },
            { filename: "/audio/j4_e.wav", start: 166352328, end: 166367236 },
            { filename: "/audio/j4_eth.mp3", start: 166367236, end: 166766097 },
            { filename: "/audio/j4_f.wav", start: 166766097, end: 166776909 },
            { filename: "/audio/j4t_1.wav", start: 166776909, end: 166807177 },
            { filename: "/audio/j4t_2.wav", start: 166807177, end: 166822085 },
            { filename: "/audio/j4t_3.wav", start: 166822085, end: 166836225 },
            { filename: "/audio/j4t_4.wav", start: 166836225, end: 166845757 },
            { filename: "/audio/j5_dst.mp3", start: 166845757, end: 167199061 },
            { filename: "/audio/j6_1.wav", start: 167199061, end: 167222929 },
            { filename: "/audio/j6_a.wav", start: 167222929, end: 167232973 },
            { filename: "/audio/j6_b.wav", start: 167232973, end: 167245065 },
            { filename: "/audio/j6_c.wav", start: 167245065, end: 167248965 },
            { filename: "/audio/j6_d.wav", start: 167248965, end: 167312871 },
            { filename: "/audio/j6_tbj.mp3", start: 167312871, end: 167677041 },
            { filename: "/audio/k1_a.wav", start: 167677041, end: 167734013 },
            { filename: "/audio/k1_b.wav", start: 167734013, end: 167743801 },
            { filename: "/audio/k1_kbo.mp3", start: 167743801, end: 168279335 },
            { filename: "/audio/k2_gis.mp3", start: 168279335, end: 168938167 },
            { filename: "/audio/k3_ds.mp3", start: 168938167, end: 169356672 },
            { filename: "/audio/k4_shi.mp3", start: 169356672, end: 169680718 },
            { filename: "/audio/k4_shi2.mp3", start: 169680718, end: 169894841 },
            { filename: "/audio/k5_sd.mp3", start: 169894841, end: 170460468 },
            { filename: "/audio/l1_lg.mp3", start: 170460468, end: 171512181 },
            { filename: "/audio/l2_a.wav", start: 171512181, end: 171543729 },
            { filename: "/audio/l2_dsb.mp3", start: 171543729, end: 172084278 },
            { filename: "/audio/l3_dm.mp3", start: 172084278, end: 172567567 },
            { filename: "/audio/l4_pap.mp3", start: 172567567, end: 172933409 },
            { filename: "/audio/l5_tfb.mp3", start: 172933409, end: 173382007 },
            { filename: "/audio/lib_a.wav", start: 173382007, end: 173402547 },
            { filename: "/audio/lib_a1.wav", start: 173402547, end: 173420271 },
            { filename: "/audio/lib_a2.wav", start: 173420271, end: 173435179 },
            { filename: "/audio/lib_b.wav", start: 173435179, end: 173474407 },
            { filename: "/audio/lib_c.wav", start: 173474407, end: 173491875 },
            { filename: "/audio/lib_d.wav", start: 173491875, end: 173499871 },
            { filename: "/audio/lo2_a.wav", start: 173499871, end: 173573393 },
            { filename: "/audio/lo6_a.wav", start: 173573393, end: 173668525 },
            { filename: "/audio/mf1_a.wav", start: 173668525, end: 173691881 },
            { filename: "/audio/mf2_a.wav", start: 173691881, end: 173716261 },
            { filename: "/audio/mf3_a.wav", start: 173716261, end: 173742689 },
            { filename: "/audio/mf3_b.wav", start: 173742689, end: 173770653 },
            { filename: "/audio/mf3_b1.wav", start: 173770653, end: 173782489 },
            { filename: "/audio/mf3_c.wav", start: 173782489, end: 173814549 },
            { filename: "/audio/mf4_a.wav", start: 173814549, end: 173828433 },
            { filename: "/audio/mf4_b.wav", start: 173828433, end: 173856653 },
            { filename: "/audio/mf4_c.wav", start: 173856653, end: 173873097 },
            { filename: "/audio/mt_ph1.mp3", start: 173873097, end: 174310410 },
            { filename: "/audio/mt_ph2.mp3", start: 174310410, end: 174742708 },
            { filename: "/audio/mt_ph3.mp3", start: 174742708, end: 175063829 },
            { filename: "/audio/mt_ph4.mp3", start: 175063829, end: 175384532 },
            { filename: "/audio/police.wav", start: 175384532, end: 207283216 },
            { filename: "/audio/r0_pdr2.mp3", start: 207283216, end: 207871413 },
            { filename: "/audio/r1_a.wav", start: 207871413, end: 207931519 },
            { filename: "/audio/r1_sw.mp3", start: 207931519, end: 208287748 },
            { filename: "/audio/r2_a.wav", start: 208287748, end: 208302656 },
            { filename: "/audio/r2_ap.mp3", start: 208302656, end: 208938918 },
            { filename: "/audio/r2_b.wav", start: 208938918, end: 208959970 },
            { filename: "/audio/r2_c.wav", start: 208959970, end: 208977182 },
            { filename: "/audio/r2_d.wav", start: 208977182, end: 208984922 },
            { filename: "/audio/r2_e.wav", start: 208984922, end: 209000598 },
            { filename: "/audio/r2_f.wav", start: 209000598, end: 209023442 },
            { filename: "/audio/r2_g.wav", start: 209023442, end: 209055758 },
            { filename: "/audio/r2_h.wav", start: 209055758, end: 209069642 },
            { filename: "/audio/r3_ed.mp3", start: 209069642, end: 209769434 },
            { filename: "/audio/r4_gf.mp3", start: 209769434, end: 210114796 },
            { filename: "/audio/r5_a.wav", start: 210114796, end: 210189624 },
            { filename: "/audio/r5_pb.mp3", start: 210189624, end: 210515342 },
            { filename: "/audio/r6_a.wav", start: 210515342, end: 210522058 },
            { filename: "/audio/r6_a1.wav", start: 210522058, end: 210540806 },
            { filename: "/audio/r6_b.wav", start: 210540806, end: 210545474 },
            { filename: "/audio/r6_mm.mp3", start: 210545474, end: 210920511 },
            { filename: "/audio/s0_mas.mp3", start: 210920511, end: 211687176 },
            { filename: "/audio/s1_a.wav", start: 211687176, end: 211705156 },
            { filename: "/audio/s1_a1.wav", start: 211705156, end: 211728512 },
            { filename: "/audio/s1_b.wav", start: 211728512, end: 211741884 },
            { filename: "/audio/s1_c.wav", start: 211741884, end: 211749368 },
            { filename: "/audio/s1_c1.wav", start: 211749368, end: 211775540 },
            { filename: "/audio/s1_d.wav", start: 211775540, end: 211791472 },
            { filename: "/audio/s1_e.wav", start: 211791472, end: 211811244 },
            { filename: "/audio/s1_f.wav", start: 211811244, end: 211822824 },
            { filename: "/audio/s1_g.wav", start: 211822824, end: 211847204 },
            { filename: "/audio/s1_h.wav", start: 211847204, end: 211912296 },
            { filename: "/audio/s1_i.wav", start: 211912296, end: 211917476 },
            { filename: "/audio/s1_j.wav", start: 211917476, end: 211931360 },
            { filename: "/audio/s1_k.wav", start: 211931360, end: 211963420 },
            { filename: "/audio/s1_l.wav", start: 211963420, end: 211979864 },
            { filename: "/audio/s1_pf.mp3", start: 211979864, end: 212702225 },
            { filename: "/audio/s2_ctg.mp3", start: 212702225, end: 213342249 },
            { filename: "/audio/s2_ctg2.mp3", start: 213342249, end: 213985616 },
            { filename: "/audio/s3_a.wav", start: 213985616, end: 214005900 },
            { filename: "/audio/s3_b.wav", start: 214005900, end: 214083340 },
            { filename: "/audio/s3_rtc.mp3", start: 214083340, end: 214725035 },
            { filename: "/audio/s4_bdba.mp3", start: 214725035, end: 215010629 },
            { filename: "/audio/s4_bdbb.mp3", start: 215010629, end: 215274907 },
            { filename: "/audio/s4_bdbd.mp3", start: 215274907, end: 215815456 },
            { filename: "/audio/s5_lrq.mp3", start: 215815456, end: 216264890 },
            { filename: "/audio/s5_lrqb.mp3", start: 216264890, end: 216906585 },
            { filename: "/audio/s5_lrqc.mp3", start: 216906585, end: 217388202 },
            { filename: "/audio/sfx.SDT", start: 217388202, end: 217448842 },
            { filename: "/audio/t1_tol.mp3", start: 217448842, end: 217983540 },
            { filename: "/audio/t2_tpu.mp3", start: 217983540, end: 218341859 },
            { filename: "/audio/t3_a.wav", start: 218341859, end: 218345247 },
            { filename: "/audio/t3_b.wav", start: 218345247, end: 218350427 },
            { filename: "/audio/t3_c.wav", start: 218350427, end: 218356631 },
            { filename: "/audio/t3_mas.mp3", start: 218356631, end: 218694470 },
            { filename: "/audio/t4_a.wav", start: 218694470, end: 218762056 },
            { filename: "/audio/t4_tat.mp3", start: 218762056, end: 219157573 },
            { filename: "/audio/t5_bf.mp3", start: 219157573, end: 219619546 },
            { filename: "/audio/yd2_ass.wav", start: 219619546, end: 219639062 },
            { filename: "/audio/yd2_b.wav", start: 219639062, end: 219669074 },
            { filename: "/audio/yd2_c.wav", start: 219669074, end: 219681422 },
            { filename: "/audio/yd2_c1.wav", start: 219681422, end: 219688138 },
            { filename: "/audio/yd2_d.wav", start: 219688138, end: 219707142 },
            { filename: "/audio/yd2_e.wav", start: 219707142, end: 219724610 },
            { filename: "/audio/yd2_f.wav", start: 219724610, end: 219745150 },
            { filename: "/audio/yd2_g.wav", start: 219745150, end: 219763642 },
            { filename: "/audio/yd2_h.wav", start: 219763642, end: 219790070 },
            { filename: "/audio/yd2_ok.wav", start: 219790070, end: 219824434 },
            { filename: "/audio/yd_ph1.mp3", start: 219824434, end: 220256314 },
            { filename: "/audio/yd_ph2.mp3", start: 220256314, end: 220506382 },
            { filename: "/audio/yd_ph3.mp3", start: 220506382, end: 220856342 },
            { filename: "/audio/yd_ph4.mp3", start: 220856342, end: 221023654 },
            { filename: "/cheat code gta 3.txt", start: 221023654, end: 221024857 },
            { filename: "/data/CAPS.DAT", start: 221024857, end: 221024873 },
            { filename: "/data/CULLZONE.DAT", start: 221024873, end: 221182997 },
            { filename: "/data/animviewer.dat", start: 221182997, end: 221183401 },
            { filename: "/data/carcols.dat", start: 221183401, end: 221189346 },
            { filename: "/data/default.dat", start: 221189346, end: 221189961 },
            { filename: "/data/default.ide", start: 221189961, end: 221201684 },
            { filename: "/data/fistfite.dat", start: 221201684, end: 221202952 },
            { filename: "/data/gta3.dat", start: 221202952, end: 221204962 },
            { filename: "/data/gta3.zon", start: 221204962, end: 221207930 },
            { filename: "/data/handling.cfg", start: 221207930, end: 221219526 },
            { filename: "/data/main.scm", start: 221219526, end: 221826079 },
            { filename: "/data/map.zon", start: 221826079, end: 221827779 },
            { filename: "/data/maps/comNbtm.ipl", start: 221827779, end: 221896438 },
            { filename: "/data/maps/comNtop.ipl", start: 221896438, end: 221977868 },
            { filename: "/data/maps/comSE.ipl", start: 221977868, end: 222020893 },
            { filename: "/data/maps/comSW.ipl", start: 222020893, end: 222081317 },
            { filename: "/data/maps/comnbtm/comNbtm.col", start: 222081317, end: 222399353 },
            { filename: "/data/maps/comnbtm/comNbtm.ipl", start: 222399353, end: 222468086 },
            { filename: "/data/maps/comnbtm/comnbtm.ide", start: 222468086, end: 222504260 },
            { filename: "/data/maps/comntop/comNtop.col", start: 222504260, end: 222764368 },
            { filename: "/data/maps/comntop/comNtop.ipl", start: 222764368, end: 222846032 },
            { filename: "/data/maps/comntop/comntop.ide", start: 222846032, end: 222871512 },
            { filename: "/data/maps/comroad/comroad.col", start: 222871512, end: 223028272 },
            { filename: "/data/maps/comroad/comroad.ide", start: 223028272, end: 223114824 },
            { filename: "/data/maps/comroad/comroad.ipl", start: 223114824, end: 223123401 },
            { filename: "/data/maps/comse/comSE.col", start: 223123401, end: 223294725 },
            { filename: "/data/maps/comse/comSE.ipl", start: 223294725, end: 223337760 },
            { filename: "/data/maps/comse/comse.ide", start: 223337760, end: 223366834 },
            { filename: "/data/maps/comsw/comSW.col", start: 223366834, end: 223584510 },
            { filename: "/data/maps/comsw/comSW.ipl", start: 223584510, end: 223644944 },
            { filename: "/data/maps/comsw/comsw.ide", start: 223644944, end: 223675785 },
            { filename: "/data/maps/cull.ipl", start: 223675785, end: 223742691 },
            { filename: "/data/maps/generic.ide", start: 223742691, end: 223825467 },
            { filename: "/data/maps/gta3.IDE", start: 223825467, end: 224438535 },
            { filename: "/data/maps/indroads/indroads.col", start: 224438535, end: 224595603 },
            { filename: "/data/maps/indroads/indroads.ide", start: 224595603, end: 224681777 },
            { filename: "/data/maps/indroads/indroads.ipl", start: 224681777, end: 224690341 },
            { filename: "/data/maps/industNE.ipl", start: 224690341, end: 224731810 },
            { filename: "/data/maps/industNW.ipl", start: 224731810, end: 224785306 },
            { filename: "/data/maps/industSE.ipl", start: 224785306, end: 224840202 },
            { filename: "/data/maps/industSW.ipl", start: 224840202, end: 224890620 },
            { filename: "/data/maps/industne/industNE.col", start: 224890620, end: 225139020 },
            { filename: "/data/maps/industne/industNE.ipl", start: 225139020, end: 225180317 },
            { filename: "/data/maps/industne/industne.ide", start: 225180317, end: 225188987 },
            { filename: "/data/maps/industnw/industNW.col", start: 225188987, end: 225352691 },
            { filename: "/data/maps/industnw/industNW.ipl", start: 225352691, end: 225406266 },
            { filename: "/data/maps/industnw/industnw.ide", start: 225406266, end: 225420093 },
            { filename: "/data/maps/industse/industSE.col", start: 225420093, end: 225660657 },
            { filename: "/data/maps/industse/industSE.ipl", start: 225660657, end: 225715838 },
            { filename: "/data/maps/industse/industse.ide", start: 225715838, end: 225748497 },
            { filename: "/data/maps/industsw/industSW.col", start: 225748497, end: 225913817 },
            { filename: "/data/maps/industsw/industSW.ipl", start: 225913817, end: 225964247 },
            { filename: "/data/maps/industsw/industsw.ide", start: 225964247, end: 225986823 },
            { filename: "/data/maps/landne/landne.col", start: 225986823, end: 226451351 },
            { filename: "/data/maps/landne/landne.ide", start: 226451351, end: 226476020 },
            { filename: "/data/maps/landne/landne.ipl", start: 226476020, end: 226548243 },
            { filename: "/data/maps/landsw/landsw.col", start: 226548243, end: 226996675 },
            { filename: "/data/maps/landsw/landsw.ide", start: 226996675, end: 227052218 },
            { filename: "/data/maps/landsw/landsw.ipl", start: 227052218, end: 227147495 },
            { filename: "/data/maps/making/making.col", start: 227147495, end: 227167095 },
            { filename: "/data/maps/making/making.ide", start: 227167095, end: 227169856 },
            { filename: "/data/maps/making/making.ipl", start: 227169856, end: 227172668 },
            { filename: "/data/maps/overview.ipl", start: 227172668, end: 227179810 },
            { filename: "/data/maps/props.IPL", start: 227179810, end: 227216976 },
            { filename: "/data/maps/subroads/subroads.col", start: 227216976, end: 227386852 },
            { filename: "/data/maps/subroads/subroads.ide", start: 227386852, end: 227457842 },
            { filename: "/data/maps/subroads/subroads.ipl", start: 227457842, end: 227465940 },
            { filename: "/data/maps/suburbne.ipl", start: 227465940, end: 227538085 },
            { filename: "/data/maps/suburbsw.ipl", start: 227538085, end: 227632924 },
            { filename: "/data/maps/temppart/temppart.col", start: 227632924, end: 227692884 },
            { filename: "/data/maps/temppart/temppart.ide", start: 227692884, end: 227698820 },
            { filename: "/data/maps/temppart/temppart.ipl", start: 227698820, end: 227707366 },
            { filename: "/data/object.dat", start: 227707366, end: 227721951 },
            { filename: "/data/particle.cfg", start: 227721951, end: 227745525 },
            { filename: "/data/paths/CHASE0.DAT", start: 227745525, end: 227896725 },
            { filename: "/data/paths/CHASE1.DAT", start: 227896725, end: 228047925 },
            { filename: "/data/paths/CHASE10.DAT", start: 228047925, end: 228115125 },
            { filename: "/data/paths/CHASE11.DAT", start: 228115125, end: 228182325 },
            { filename: "/data/paths/CHASE14.DAT", start: 228182325, end: 228249525 },
            { filename: "/data/paths/CHASE16.DAT", start: 228249525, end: 228316725 },
            { filename: "/data/paths/CHASE18.DAT", start: 228316725, end: 228383925 },
            { filename: "/data/paths/CHASE19.DAT", start: 228383925, end: 228451125 },
            { filename: "/data/paths/CHASE2.DAT", start: 228451125, end: 228602325 },
            { filename: "/data/paths/CHASE3.DAT", start: 228602325, end: 228753525 },
            { filename: "/data/paths/CHASE4.DAT", start: 228753525, end: 228820725 },
            { filename: "/data/paths/CHASE5.DAT", start: 228820725, end: 228887925 },
            { filename: "/data/paths/CHASE6.DAT", start: 228887925, end: 228955125 },
            { filename: "/data/paths/CHASE7.DAT", start: 228955125, end: 229022325 },
            { filename: "/data/paths/flight.dat", start: 229022325, end: 229025071 },
            { filename: "/data/paths/flight2.dat", start: 229025071, end: 229026185 },
            { filename: "/data/paths/flight3.dat", start: 229026185, end: 229027355 },
            { filename: "/data/paths/flight4.dat", start: 229027355, end: 229030844 },
            { filename: "/data/paths/tracks.dat", start: 229030844, end: 229035174 },
            { filename: "/data/paths/tracks2.dat", start: 229035174, end: 229050197 },
            { filename: "/data/ped.dat", start: 229050197, end: 229052264 },
            { filename: "/data/pedgrp.dat", start: 229052264, end: 229055487 },
            { filename: "/data/pedstats.dat", start: 229055487, end: 229058463 },
            { filename: "/data/surface.dat", start: 229058463, end: 229058950 },
            { filename: "/data/timecyc.dat", start: 229058950, end: 229081166 },
            { filename: "/data/train.dat", start: 229081166, end: 229083642 },
            { filename: "/data/train2.dat", start: 229083642, end: 229087874 },
            { filename: "/data/water.dat", start: 229087874, end: 229090513 },
            { filename: "/data/waterpro.dat", start: 229090513, end: 229111957 },
            { filename: "/data/weapon.dat", start: 229111957, end: 229114913 },
            { filename: "/gta3.exe", start: 229114913, end: 231498785 },
            { filename: "/gta3.ini", start: 231498785, end: 231498795 },
            { filename: "/models/Coll/commer.col", start: 231498795, end: 232622123 },
            { filename: "/models/Coll/generic.col", start: 232622123, end: 232973111 },
            { filename: "/models/Coll/indust.col", start: 232973111, end: 234027039 },
            { filename: "/models/Coll/peds.col", start: 234027039, end: 234048516 },
            { filename: "/models/Coll/suburb.col", start: 234048516, end: 235130516 },
            { filename: "/models/Coll/vehicles.col", start: 235130516, end: 235186928 },
            { filename: "/models/Coll/weapons.col", start: 235186928, end: 235188836 },
            { filename: "/models/Generic/air_vlo.DFF", start: 235188836, end: 235195844 },
            { filename: "/models/Generic/arrow.DFF", start: 235195844, end: 235200693 },
            { filename: "/models/Generic/loplyguy.dff", start: 235200693, end: 235219421 },
            { filename: "/models/Generic/peds.dff", start: 235219421, end: 236325694 },
            { filename: "/models/Generic/player.bmp", start: 236325694, end: 236522356 },
            { filename: "/models/Generic/qsphere.DFF", start: 236522356, end: 236527527 },
            { filename: "/models/Generic/sphere.DFF", start: 236527527, end: 236549109 },
            { filename: "/models/Generic/weapons.dff", start: 236549109, end: 236714008 },
            { filename: "/models/Generic/wheels.DFF", start: 236714008, end: 236799418 },
            { filename: "/models/Generic/zonecyla.DFF", start: 236799418, end: 236800958 },
            { filename: "/models/Generic/zonecylb.DFF", start: 236800958, end: 236803218 },
            { filename: "/models/Generic/zonesphr.DFF", start: 236803218, end: 236807554 },
            { filename: "/models/MISC.TXD", start: 236807554, end: 236915498 },
            { filename: "/models/fonts.txd", start: 236915498, end: 238295250 },
            { filename: "/models/frontend.txd", start: 238295250, end: 243183610 },
            { filename: "/models/generic.txd", start: 243183610, end: 243843490 },
            { filename: "/models/gta3.dir", start: 243843490, end: 243966882 },
            { filename: "/models/gta3.img", start: 243966882, end: 414858146 },
            { filename: "/models/hud.txd", start: 414858146, end: 415029962 },
            { filename: "/models/menu.txd", start: 415029962, end: 422914162 },
            { filename: "/models/particle.txd", start: 422914162, end: 423378202 },
            { filename: "/models/txd.dir", start: 423378202, end: 423401146 },
            { filename: "/models/txd.img", start: 423401146, end: 754691770 },
            { filename: "/movies/GTAtitles.mpg", start: 754691770, end: 755431102 },
            { filename: "/movies/GTAtitlesGER.mpg", start: 755431102, end: 756170434 },
            { filename: "/movies/Logo.mpg", start: 756170434, end: 757292926 },
            { filename: "/mp3/MP3Report.txt", start: 757292926, end: 757293105 },
            { filename: "/mss/Mp3dec.asi", start: 757293105, end: 757419057 },
            { filename: "/mss/Mssa3d.m3d", start: 757419057, end: 757470257 },
            { filename: "/mss/Mssa3d2.m3d", start: 757470257, end: 757531185 },
            { filename: "/mss/Mssds3dh.m3d", start: 757531185, end: 757581873 },
            { filename: "/mss/Mssds3ds.m3d", start: 757581873, end: 757632561 },
            { filename: "/mss/Msseax.m3d", start: 757632561, end: 757686321 },
            { filename: "/mss/Mssfast.m3d", start: 757686321, end: 757749297 },
            { filename: "/mss/Mssrsx.m3d", start: 757749297, end: 758102065 },
            { filename: "/mss/Reverb3.flt", start: 758102065, end: 758158897 },
            { filename: "/mss/msseax3.m3d", start: 758158897, end: 758231601 },
            { filename: "/myth.acm", start: 758231601, end: 758529585 },
            { filename: "/mythXuha.exe", start: 758529585, end: 758630449 },
            { filename: "/mythxpak.exe", start: 758630449, end: 758651441 },
            { filename: "/setup.bat", start: 758651441, end: 758651937 },
            { filename: "/skins/playa2.bmp", start: 758651937, end: 758718549 },
            { filename: "/skins/player.bmp", start: 758718549, end: 758915211 },
            { filename: "/txd/LOADSC0.TXD", start: 758915211, end: 759178547 },
            { filename: "/txd/LOADSC1.TXD", start: 759178547, end: 759441883 },
            { filename: "/txd/LOADSC10.TXD", start: 759441883, end: 759705219 },
            { filename: "/txd/LOADSC11.TXD", start: 759705219, end: 759968555 },
            { filename: "/txd/LOADSC12.TXD", start: 759968555, end: 760231891 },
            { filename: "/txd/LOADSC13.TXD", start: 760231891, end: 760495227 },
            { filename: "/txd/LOADSC14.TXD", start: 760495227, end: 760758563 },
            { filename: "/txd/LOADSC15.TXD", start: 760758563, end: 761021899 },
            { filename: "/txd/LOADSC16.TXD", start: 761021899, end: 761285235 },
            { filename: "/txd/LOADSC17.TXD", start: 761285235, end: 761548571 },
            { filename: "/txd/LOADSC18.TXD", start: 761548571, end: 761811907 },
            { filename: "/txd/LOADSC19.TXD", start: 761811907, end: 762075243 },
            { filename: "/txd/LOADSC2.TXD", start: 762075243, end: 762338579 },
            { filename: "/txd/LOADSC20.TXD", start: 762338579, end: 762601915 },
            { filename: "/txd/LOADSC21.TXD", start: 762601915, end: 762865251 },
            { filename: "/txd/LOADSC22.TXD", start: 762865251, end: 763128587 },
            { filename: "/txd/LOADSC23.TXD", start: 763128587, end: 763391923 },
            { filename: "/txd/LOADSC24.TXD", start: 763391923, end: 763655259 },
            { filename: "/txd/LOADSC25.TXD", start: 763655259, end: 763918595 },
            { filename: "/txd/LOADSC3.TXD", start: 763918595, end: 764181931 },
            { filename: "/txd/LOADSC4.TXD", start: 764181931, end: 764445267 },
            { filename: "/txd/LOADSC5.TXD", start: 764445267, end: 764708603 },
            { filename: "/txd/LOADSC6.TXD", start: 764708603, end: 764971939 },
            { filename: "/txd/LOADSC7.TXD", start: 764971939, end: 765235275 },
            { filename: "/txd/LOADSC8.TXD", start: 765235275, end: 765498611 },
            { filename: "/txd/LOADSC9.TXD", start: 765498611, end: 765761947 },
            { filename: "/txd/NEWS.TXD", start: 765761947, end: 766025283 },
            { filename: "/txd/SPLASH1.TXD", start: 766025283, end: 766157547 },
            { filename: "/txd/SPLASH2.TXD", start: 766157547, end: 766289811 },
            { filename: "/txd/SPLASH3.TXD", start: 766289811, end: 766422075 },
            { filename: "/txd/mainsc1.txd", start: 766422075, end: 767471843 },
            { filename: "/txd/mainsc2.txd", start: 767471843, end: 768521611 },
        ],
        remote_package_size: 768521611,
    });
})();
var arguments_ = [];
...
var AL = {
    ...
    ALC_EXTENSIONS: { ALC_EXT_capture: true, ALC_SOFT_pause_device: true, ALC_SOFT_HRTF: true },
    AL_EXTENSIONS: {
        AL_EXT_float32: true,
...
var Browser = {
    ...
    init() {
        ...
        audioPlugin["canHandle"] = (name) =>
            !Module["noAudioDecoding"] && name.slice(-4) in { ".ogg": 1, ".wav": 1, ".mp3": 1 };
...
var ASM_CONSTS = {
    ...
    368467: () => window.innerWidth,
    368497: () => window.innerHeight,
    368528: ($0) => {
        if (!$0) {
            AL.alcErr = 40964;
            return 1;
...
function assignWasmExports(wasmExports) {
    _malloc = wasmExports["ph"];
    _main = Module["_main"] = wasmExports["qh"];
    __emscripten_stack_restore = wasmExports["rh"];
    __emscripten_stack_alloc = wasmExports["sh"];
    _emscripten_stack_get_current = wasmExports["th"];
    dynCall_iii = dynCalls["iii"] = wasmExports["uh"];
    dynCall_ii = dynCalls["ii"] = wasmExports["vh"];
    dynCall_vi = dynCalls["vi"] = wasmExports["wh"];
    dynCall_iiii = dynCalls["iiii"] = wasmExports["xh"];
    dynCall_iiiii = dynCalls["iiiii"] = wasmExports["yh"];
    dynCall_vii = dynCalls["vii"] = wasmExports["zh"];
    dynCall_vff = dynCalls["vff"] = wasmExports["Ah"];
    dynCall_v = dynCalls["v"] = wasmExports["Bh"];
    dynCall_viiii = dynCalls["viiii"] = wasmExports["Ch"];
    dynCall_viii = dynCalls["viii"] = wasmExports["Dh"];
    dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["Eh"];
    dynCall_viiif = dynCalls["viiif"] = wasmExports["Fh"];
    dynCall_fi = dynCalls["fi"] = wasmExports["Gh"];
    dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Hh"];
    dynCall_viiifi = dynCalls["viiifi"] = wasmExports["Ih"];
    dynCall_viiiii = dynCalls["viiiii"] = wasmExports["Jh"];
    dynCall_vffff = dynCalls["vffff"] = wasmExports["Kh"];
    dynCall_vf = dynCalls["vf"] = wasmExports["Lh"];
    dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Mh"];
    dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["Nh"];
    dynCall_i = dynCalls["i"] = wasmExports["Oh"];
    dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["Ph"];
    dynCall_vfi = dynCalls["vfi"] = wasmExports["Qh"];
    dynCall_viif = dynCalls["viif"] = wasmExports["Rh"];
    dynCall_vif = dynCalls["vif"] = wasmExports["Sh"];
    ...
    dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Wh"];
    dynCall_vfff = dynCalls["vfff"] = wasmExports["Xh"];
    dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Yh"];
    dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["Zh"];
    dynCall_viifi = dynCalls["viifi"] = wasmExports["_h"];
    dynCall_iiij = dynCalls["iiij"] = wasmExports["$h"];
    dynCall_viij = dynCalls["viij"] = wasmExports["ai"];
    dynCall_ji = dynCalls["ji"] = wasmExports["bi"];
    dynCall_jiji = dynCalls["jiji"] = wasmExports["ci"];
    dynCall_fii = dynCalls["fii"] = wasmExports["di"];
    dynCall_jij = dynCalls["jij"] = wasmExports["ei"];
    dynCall_iij = dynCalls["iij"] = wasmExports["fi"];
    dynCall_di = dynCalls["di"] = wasmExports["gi"];
    dynCall_viifff = dynCalls["viifff"] = wasmExports["hi"];
    dynCall_iidiiii = dynCalls["iidiiii"] = wasmExports["ii"];
    dynCall_viijii = dynCalls["viijii"] = wasmExports["ji"];
    dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["ki"];
    dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["li"];
    dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["mi"];
    dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["ni"];
    dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["oi"];
    dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["pi"];
    memory = wasmMemory = wasmExports["nh"];
    __indirect_function_table = wasmExports["__indirect_function_table"];
}
var wasmImports = {
    E: ___cxa_throw,
    Rb: ___syscall_chdir,
    Sb: ___syscall_faccessat,
    f: ___syscall_fcntl64,
    Pb: ___syscall_getcwd,
    Db: ___syscall_getdents64,
    Ub: ___syscall_ioctl,
    Ib: ___syscall_lstat64,
    Jb: ___syscall_newfstatat,
    K: ___syscall_openat,
    zb: ___syscall_poll,
    Cb: ___syscall_readlinkat,
    Ab: ___syscall_renameat,
    Kb: ___syscall_stat64,
    yb: ___syscall_unlinkat,
    Eb: __abort_js,
    Fb: __gmtime_js,
    Gb: __localtime_js,
    Hb: __tzset_js,
    ...
    i: _alSourcePlay,
    jc: _alSourcePlayv,
    e: _alSourceQueueBuffers,
    fc: _alSourceRewind,
    hc: _alSourceRewindv,
    k: _alSourceStop,
    ic: _alSourceStopv,
    q: _alSourceUnqueueBuffers,
    b: _alSourcef,
    rc: _alSourcefv,
    c: _alSourcei,
    qc: _alSourceiv,
    Oc: _alSpeedOfSound,
    ua: _alcCloseDevice,
    pa: _alcCreateContext,
    va: _alcDestroyContext,
    I: _alcGetIntegerv,
    H: _alcGetString,
    l: _alcIsExtensionPresent,
    u: _alcMakeContextCurrent,
    ta: _alcOpenDevice,
    Xc: _alcSuspendContext,
    jd: _eglBindAPI,
    md: _eglChooseConfig,
    ad: _eglCreateContext,
    cd: _eglCreateWindowSurface,
    bd: _eglDestroyContext,
    dd: _eglDestroySurface,
    nd: _eglGetConfigAttrib,
    ia: _eglGetDisplay,
    $c: _eglGetError,
    kd: _eglInitialize,
    ed: _eglMakeCurrent,
    ...
    Yc: _emscripten_asm_const_ptr_sync_on_main_thread,
    Qc: _emscripten_cancel_main_loop,
    L: _emscripten_date_now,
    Qb: _emscripten_err,
    Sc: _emscripten_exit_fullscreen,
    Wc: _emscripten_exit_pointerlock,
    ...
    od: _emscripten_get_num_gamepads,
    Zc: _emscripten_get_screen_size,
    jb: _emscripten_glActiveTexture,
    ib: _emscripten_glAttachShader,
    cf: _emscripten_glBeginQuery,
    Tb: _emscripten_glBeginQueryEXT,
    Le: _emscripten_glBeginTransformFeedback,
    hb: _emscripten_glBindAttribLocation,
    gb: _emscripten_glBindBuffer,
    Ie: _emscripten_glBindBufferBase,
    Je: _emscripten_glBindBufferRange,
    fb: _emscripten_glBindFramebuffer,
    eb: _emscripten_glBindRenderbuffer,
    Qd: _emscripten_glBindSampler,
    db: _emscripten_glBindTexture,
    Id: _emscripten_glBindTransformFeedback,
    Qe: _emscripten_glBindVertexArray,
    rb: _emscripten_glBindVertexArrayOES,
    cb: _emscripten_glBlendColor,
    bb: _emscripten_glBlendEquation,
    ab: _emscripten_glBlendEquationSeparate,
    $a: _emscripten_glBlendFunc,
    _a: _emscripten_glBlendFuncSeparate,
    Te: _emscripten_glBlitFramebuffer,
    Za: _emscripten_glBufferData,
    Ya: _emscripten_glBufferSubData,
    Xa: _emscripten_glCheckFramebufferStatus,
    Wa: _emscripten_glClear,
    le: _emscripten_glClearBufferfi,
    me: _emscripten_glClearBufferfv,
    oe: _emscripten_glClearBufferiv,
    ne: _emscripten_glClearBufferuiv,
    Va: _emscripten_glClearColor,
    Ua: _emscripten_glClearDepthf,
    Ta: _emscripten_glClearStencil,
    Zd: _emscripten_glClientWaitSync,
    tf: _emscripten_glClipControlEXT,
    Sa: _emscripten_glColorMask,
    Ra: _emscripten_glCompileShader,
    Qa: _emscripten_glCompressedTexImage2D,
    hf: _emscripten_glCompressedTexImage3D,
    Pa: _emscripten_glCompressedTexSubImage2D,
    gf: _emscripten_glCompressedTexSubImage3D,
    je: _emscripten_glCopyBufferSubData,
    Oa: _emscripten_glCopyTexImage2D,
    Na: _emscripten_glCopyTexSubImage2D,
    jf: _emscripten_glCopyTexSubImage3D,
    Ma: _emscripten_glCreateProgram,
    La: _emscripten_glCreateShader,
    Ka: _emscripten_glCullFace,
    Ja: _emscripten_glDeleteBuffers,
    Ia: _emscripten_glDeleteFramebuffers,
    Ha: _emscripten_glDeleteProgram,
    ef: _emscripten_glDeleteQueries,
    kc: _emscripten_glDeleteQueriesEXT,
    Ga: _emscripten_glDeleteRenderbuffers,
    Sd: _emscripten_glDeleteSamplers,
    Fa: _emscripten_glDeleteShader,
    _d: _emscripten_glDeleteSync,
    Ea: _emscripten_glDeleteTextures,
    Hd: _emscripten_glDeleteTransformFeedbacks,
    Pe: _emscripten_glDeleteVertexArrays,
    qb: _emscripten_glDeleteVertexArraysOES,
    Da: _emscripten_glDepthFunc,
    Ca: _emscripten_glDepthMask,
    Ba: _emscripten_glDepthRangef,
    Aa: _emscripten_glDetachShader,
    za: _emscripten_glDisable,
    ya: _emscripten_glDisableVertexAttribArray,
    xa: _emscripten_glDrawArrays,
    ce: _emscripten_glDrawArraysInstanced,
    mb: _emscripten_glDrawArraysInstancedANGLE,
    rd: _emscripten_glDrawArraysInstancedARB,
    qf: _emscripten_glDrawArraysInstancedEXT,
    sd: _emscripten_glDrawArraysInstancedNV,
    _e: _emscripten_glDrawBuffers,
    of: _emscripten_glDrawBuffersEXT,
    nb: _emscripten_glDrawBuffersWEBGL,
    wa: _emscripten_glDrawElements,
    be: _emscripten_glDrawElementsInstanced,
    lb: _emscripten_glDrawElementsInstancedANGLE,
    pd: _emscripten_glDrawElementsInstancedARB,
    qd: _emscripten_glDrawElementsInstancedEXT,
    pf: _emscripten_glDrawElementsInstancedNV,
    mf: _emscripten_glDrawRangeElements,
    mh: _emscripten_glEnable,
    lh: _emscripten_glEnableVertexAttribArray,
    bf: _emscripten_glEndQuery,
    Mb: _emscripten_glEndQueryEXT,
    Ke: _emscripten_glEndTransformFeedback,
    ae: _emscripten_glFenceSync,
    kh: _emscripten_glFinish,
    jh: _emscripten_glFlush,
    ih: _emscripten_glFramebufferRenderbuffer,
    hh: _emscripten_glFramebufferTexture2D,
    Re: _emscripten_glFramebufferTextureLayer,
    gh: _emscripten_glFrontFace,
    fh: _emscripten_glGenBuffers,
    dh: _emscripten_glGenFramebuffers,
    ff: _emscripten_glGenQueries,
    vc: _emscripten_glGenQueriesEXT,
    ch: _emscripten_glGenRenderbuffers,
    Td: _emscripten_glGenSamplers,
    bh: _emscripten_glGenTextures,
    Gd: _emscripten_glGenTransformFeedbacks,
    Oe: _emscripten_glGenVertexArrays,
    pb: _emscripten_glGenVertexArraysOES,
    eh: _emscripten_glGenerateMipmap,
    ah: _emscripten_glGetActiveAttrib,
    $g: _emscripten_glGetActiveUniform,
    ee: _emscripten_glGetActiveUniformBlockName,
    fe: _emscripten_glGetActiveUniformBlockiv,
    he: _emscripten_glGetActiveUniformsiv,
    _g: _emscripten_glGetAttachedShaders,
    Zg: _emscripten_glGetAttribLocation,
    Yg: _emscripten_glGetBooleanv,
    Ud: _emscripten_glGetBufferParameteri64v,
    Xg: _emscripten_glGetBufferParameteriv,
    Wg: _emscripten_glGetError,
    Vg: _emscripten_glGetFloatv,
    xe: _emscripten_glGetFragDataLocation,
    Ug: _emscripten_glGetFramebufferAttachmentParameteriv,
    Vd: _emscripten_glGetInteger64i_v,
    Xd: _emscripten_glGetInteger64v,
    Me: _emscripten_glGetIntegeri_v,
    Tg: _emscripten_glGetIntegerv,
    vd: _emscripten_glGetInternalformativ,
    Cd: _emscripten_glGetProgramBinary,
    Rg: _emscripten_glGetProgramInfoLog,
    Sg: _emscripten_glGetProgramiv,
    tb: _emscripten_glGetQueryObjecti64vEXT,
    vb: _emscripten_glGetQueryObjectivEXT,
    sb: _emscripten_glGetQueryObjectui64vEXT,
    $e: _emscripten_glGetQueryObjectuiv,
    ub: _emscripten_glGetQueryObjectuivEXT,
    af: _emscripten_glGetQueryiv,
    wb: _emscripten_glGetQueryivEXT,
    Qg: _emscripten_glGetRenderbufferParameteriv,
    Kd: _emscripten_glGetSamplerParameterfv,
    Ld: _emscripten_glGetSamplerParameteriv,
    Og: _emscripten_glGetShaderInfoLog,
    Ng: _emscripten_glGetShaderPrecisionFormat,
    Mg: _emscripten_glGetShaderSource,
    Pg: _emscripten_glGetShaderiv,
    Lg: _emscripten_glGetString,
    ke: _emscripten_glGetStringi,
    Wd: _emscripten_glGetSynciv,
    Kg: _emscripten_glGetTexParameterfv,
    Jg: _emscripten_glGetTexParameteriv,
    Ge: _emscripten_glGetTransformFeedbackVarying,
    ge: _emscripten_glGetUniformBlockIndex,
    ie: _emscripten_glGetUniformIndices,
    Gg: _emscripten_glGetUniformLocation,
    Ig: _emscripten_glGetUniformfv,
    Hg: _emscripten_glGetUniformiv,
    ye: _emscripten_glGetUniformuiv,
    Ee: _emscripten_glGetVertexAttribIiv,
    De: _emscripten_glGetVertexAttribIuiv,
    Dg: _emscripten_glGetVertexAttribPointerv,
    Fg: _emscripten_glGetVertexAttribfv,
    Eg: _emscripten_glGetVertexAttribiv,
    Cg: _emscripten_glHint,
    zd: _emscripten_glInvalidateFramebuffer,
    yd: _emscripten_glInvalidateSubFramebuffer,
    Bg: _emscripten_glIsBuffer,
    Ag: _emscripten_glIsEnabled,
    zg: _emscripten_glIsFramebuffer,
    yg: _emscripten_glIsProgram,
    df: _emscripten_glIsQuery,
    $b: _emscripten_glIsQueryEXT,
    xg: _emscripten_glIsRenderbuffer,
    Rd: _emscripten_glIsSampler,
    wg: _emscripten_glIsShader,
    $d: _emscripten_glIsSync,
    vg: _emscripten_glIsTexture,
    Fd: _emscripten_glIsTransformFeedback,
    Ne: _emscripten_glIsVertexArray,
    ob: _emscripten_glIsVertexArrayOES,
    ug: _emscripten_glLineWidth,
    tg: _emscripten_glLinkProgram,
    Ed: _emscripten_glPauseTransformFeedback,
    sg: _emscripten_glPixelStorei,
    sf: _emscripten_glPolygonModeWEBGL,
    rg: _emscripten_glPolygonOffset,
    uf: _emscripten_glPolygonOffsetClampEXT,
    Bd: _emscripten_glProgramBinary,
    Ad: _emscripten_glProgramParameteri,
    Bb: _emscripten_glQueryCounterEXT,
    nf: _emscripten_glReadBuffer,
    qg: _emscripten_glReadPixels,
    pg: _emscripten_glReleaseShaderCompiler,
    og: _emscripten_glRenderbufferStorage,
    Se: _emscripten_glRenderbufferStorageMultisample,
    Dd: _emscripten_glResumeTransformFeedback,
    ng: _emscripten_glSampleCoverage,
    ...
    mg: _emscripten_glScissor,
    lg: _emscripten_glShaderBinary,
    kg: _emscripten_glShaderSource,
    jg: _emscripten_glStencilFunc,
    ig: _emscripten_glStencilFuncSeparate,
    hg: _emscripten_glStencilMask,
    gg: _emscripten_glStencilMaskSeparate,
    fg: _emscripten_glStencilOp,
    eg: _emscripten_glStencilOpSeparate,
    dg: _emscripten_glTexImage2D,
    lf: _emscripten_glTexImage3D,
    cg: _emscripten_glTexParameterf,
    bg: _emscripten_glTexParameterfv,
    ag: _emscripten_glTexParameteri,
    $f: _emscripten_glTexParameteriv,
    xd: _emscripten_glTexStorage2D,
    wd: _emscripten_glTexStorage3D,
    _f: _emscripten_glTexSubImage2D,
    kf: _emscripten_glTexSubImage3D,
    He: _emscripten_glTransformFeedbackVaryings,
    Zf: _emscripten_glUniform1f,
    Yf: _emscripten_glUniform1fv,
    Xf: _emscripten_glUniform1i,
    Wf: _emscripten_glUniform1iv,
    we: _emscripten_glUniform1ui,
    se: _emscripten_glUniform1uiv,
    Vf: _emscripten_glUniform2f,
    Uf: _emscripten_glUniform2fv,
    Tf: _emscripten_glUniform2i,
    Sf: _emscripten_glUniform2iv,
    ve: _emscripten_glUniform2ui,
    re: _emscripten_glUniform2uiv,
    Rf: _emscripten_glUniform3f,
    Qf: _emscripten_glUniform3fv,
    Pf: _emscripten_glUniform3i,
    Of: _emscripten_glUniform3iv,
    ue: _emscripten_glUniform3ui,
    qe: _emscripten_glUniform3uiv,
    Nf: _emscripten_glUniform4f,
    Mf: _emscripten_glUniform4fv,
    Lf: _emscripten_glUniform4i,
    Kf: _emscripten_glUniform4iv,
    te: _emscripten_glUniform4ui,
    pe: _emscripten_glUniform4uiv,
    de: _emscripten_glUniformBlockBinding,
    Jf: _emscripten_glUniformMatrix2fv,
    Ze: _emscripten_glUniformMatrix2x3fv,
    Xe: _emscripten_glUniformMatrix2x4fv,
    If: _emscripten_glUniformMatrix3fv,
    Ye: _emscripten_glUniformMatrix3x2fv,
    Ve: _emscripten_glUniformMatrix3x4fv,
    Hf: _emscripten_glUniformMatrix4fv,
    We: _emscripten_glUniformMatrix4x2fv,
    Ue: _emscripten_glUniformMatrix4x3fv,
    Gf: _emscripten_glUseProgram,
    Ff: _emscripten_glValidateProgram,
    Ef: _emscripten_glVertexAttrib1f,
    Df: _emscripten_glVertexAttrib1fv,
    Cf: _emscripten_glVertexAttrib2f,
    Bf: _emscripten_glVertexAttrib2fv,
    Af: _emscripten_glVertexAttrib3f,
    zf: _emscripten_glVertexAttrib3fv,
    yf: _emscripten_glVertexAttrib4f,
    xf: _emscripten_glVertexAttrib4fv,
    Jd: _emscripten_glVertexAttribDivisor,
    kb: _emscripten_glVertexAttribDivisorANGLE,
    td: _emscripten_glVertexAttribDivisorARB,
    rf: _emscripten_glVertexAttribDivisorEXT,
    ud: _emscripten_glVertexAttribDivisorNV,
    Ce: _emscripten_glVertexAttribI4i,
    Ae: _emscripten_glVertexAttribI4iv,
    ...
    ca: _emscripten_set_mouseenter_callback_on_thread,
    ba: _emscripten_set_mouseleave_callback_on_thread,
    ...
    aa: _emscripten_set_wheel_callback_on_thread,
    Uc: _emscripten_set_window_title,
    B: _emscripten_sleep,
    Nb: _environ_get,
...
function applySignatureConversions(wasmExports) {
    ...
    wasmExports["ph"] = makeWrapper_pp(wasmExports["ph"]);
    wasmExports["sh"] = makeWrapper_pp(wasmExports["sh"]);
    wasmExports["th"] = makeWrapper_p(wasmExports["th"]);
    return wasmExports;
}
